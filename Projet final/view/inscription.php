...
<!--===============================================================================================-->
	<link rel="stylesheet" media="screen" type="text/css" title="style" href=".../css/menu-deroulant.css"/>
</head>
<body>
		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="cible_inscription.php" method="POST">
					...
					<div class="wrap-input100 validate-input m-b-26" data-validate="le prénom est néscéssaire">
					...
					<div class="wrap-input100 validate-input m-b-26" data-validate="le mail est néscéssaire">
						...
						<div class="wrap-input100 validate-input m-b-26" data-validate="un identifiant est néscéssaire">
