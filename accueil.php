    ...
    <div class="container-fluid">
      <div class="navbar-header">
        <a class="navbar-brand">
          <img src="logo_panini.jpg" width="50" height="50" class="d-inline-block align-top" alt="Panini">Snack
        </a>
      </div>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img class="d-block w-100" src="panini1.jpg" alt="First slide">
            ...
            <div class="carousel-item">
              <img class="d-block w-100" src="salade2.jfif" alt="Second slide">
              <div class="carousel-caption d-none d-md-block">
                <h5></h5>
                <p></p>
              </div>
            ...
            <div class="carousel-item">
              <img class="d-block w-100" src="panini2.jpg" alt="Third slide">
              <div class="carousel-caption d-none d-md-block">
                <h5></h5>
                <p></p>
              </div>
